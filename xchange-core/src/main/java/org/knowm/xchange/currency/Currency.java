...
public class Currency implements Comparable<Currency>, Serializable {
  ...
  public static final Currency GBYTE = createCurrency("GBYTE", "Gbyte", null);
  public static final Currency DGD = createCurrency("DGD", "Dgd", null);
  public static final Currency DCR = createCurrency("DCR", "Bitcoin Gold", null);
  public static final Currency ZEN = createCurrency("ZEN", "Bitcoin Gold", null);
  public static final Currency BLOCK = createCurrency("BLOCK", "Bitcoin Gold", null);
  public static final Currency XZC = createCurrency("XZC", "Bitcoin Gold", null);
  public static final Currency FCT = createCurrency("FCT", "Bitcoin Gold", null);
  ...
  public static final Currency PIVX = createCurrency("PIVX", "Bitcoin Gold", null);
  public static final Currency DYN = createCurrency("DYN", "Bitcoin Gold", null);
  public static final Currency RADS = createCurrency("RADS", "Bitcoin Gold", null);
  public static final Currency SPHR = createCurrency("SPHR", "Bitcoin Gold", null);
  public static final Currency MONA = createCurrency("MONA", "Bitcoin Gold", null);
  public static final Currency SALT = createCurrency("SALT", "Bitcoin Gold", null);
  public static final Currency IOP = createCurrency("IOP", "Bitcoin Gold", null);
  public static final Currency TX = createCurrency("TX", "Bitcoin Gold", null);
  public static final Currency BNT = createCurrency("BNT", "Bitcoin Gold", null);
  public static final Currency GAME = createCurrency("GAME", "Bitcoin Gold", null);
  public static final Currency EXP = createCurrency("EXP", "Bitcoin Gold", null);
  public static final Currency PAY = createCurrency("PAY", "Bitcoin Gold", null);
  public static final Currency VIA = createCurrency("VIA", "Bitcoin Gold", null);
  public static final Currency ANT = createCurrency("ANT", "Bitcoin Gold", null);
  public static final Currency SWT = createCurrency("SWT", "Bitcoin Gold", null);
  public static final Currency EXCL = createCurrency("EXCL", "Bitcoin Gold", null);
  public static final Currency UBQ = createCurrency("UBQ", "Bitcoin Gold", null);
  public static final Currency SIB = createCurrency("SIB", "Bitcoin Gold", null);
  public static final Currency ION = createCurrency("ION", "Bitcoin Gold", null);
  public static final Currency NBT = createCurrency("NBT", "Bitcoin Gold", null);
  public static final Currency SHIFT = createCurrency("SHIFT", "Bitcoin Gold", null);
  public static final Currency NXS = createCurrency("NXS", "Bitcoin Gold", null);
  public static final Currency ADX = createCurrency("ADX", "Bitcoin Gold", null);
  public static final Currency NAV = createCurrency("NAV", "Bitcoin Gold", null);
  public static final Currency VRC = createCurrency("VRC", "Bitcoin Gold", null);
  public static final Currency QRL = createCurrency("QRL", "Bitcoin Gold", null);
  public static final Currency MYST = createCurrency("MYST", "Bitcoin Gold", null);
  public static final Currency RLC = createCurrency("RLC", "Bitcoin Gold", null);
  public static final Currency EDG = createCurrency("EDG", "Bitcoin Gold", null);
  public static final Currency DCT = createCurrency("DCT", "Bitcoin Gold", null);
  public static final Currency WINGS = createCurrency("WINGS", "Bitcoin Gold", null);
  public static final Currency AGRS = createCurrency("AGRS", "Bitcoin Gold", null);
  public static final Currency MAID = createCurrency("MAID", "Bitcoin Gold", null);
  public static final Currency _1ST = createCurrency("1ST", "Bitcoin Gold", null);
  public static final Currency CVC = createCurrency("CVC", "Bitcoin Gold", null);
  public static final Currency XEL = createCurrency("XEL", "Bitcoin Gold", null);
  public static final Currency UNB = createCurrency("UNB", "Bitcoin Gold", null);
  public static final Currency OK = createCurrency("OK", "Bitcoin Gold", null);
  public static final Currency RISE = createCurrency("RISE", "Bitcoin Gold", null);
  public static final Currency SYNX = createCurrency("SYNX", "Bitcoin Gold", null);
  public static final Currency MEME = createCurrency("MEME", "Bitcoin Gold", null);
  public static final Currency BLK = createCurrency("BLK", "Bitcoin Gold", null);
  public static final Currency SYS = createCurrency("SYS", "Bitcoin Gold", null);
  public static final Currency GNT = createCurrency("GNT", "Bitcoin Gold", null);
  public static final Currency SNGLS = createCurrency("SNGLS", "Bitcoin Gold", null);
  public static final Currency PTOY = createCurrency("PTOY", "Bitcoin Gold", null);
  public static final Currency AMP = createCurrency("AMP", "Bitcoin Gold", null);
  public static final Currency LBC = createCurrency("LBC", "Bitcoin Gold", null);
  public static final Currency BAT = createCurrency("BAT", "Bitcoin Gold", null);
  public static final Currency GUP = createCurrency("GUP", "Bitcoin Gold", null);
  public static final Currency MUE = createCurrency("MUE", "Bitcoin Gold", null);
  public static final Currency HMQ = createCurrency("HMQ", "Bitcoin Gold", null);
  public static final Currency CFI = createCurrency("CFI", "Bitcoin Gold", null);
  public static final Currency VOX = createCurrency("VOX", "Bitcoin Gold", null);
  ...
  public static final Currency SAFEX = createCurrency("SAFEX", "Bitcoin Gold", null);
  public static final Currency BURST = createCurrency("BURST", "Bitcoin Gold", null);
  public static final Currency SC = createCurrency("SC", "Bitcoin Gold", null);
  ...
  public static final Currency SRN = createCurrency("SRN", "Sirin", null);
  public static final Currency IGNIS = createCurrency("IGNIS", "Ignis", null);
